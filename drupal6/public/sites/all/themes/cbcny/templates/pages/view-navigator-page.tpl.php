...
<?php if (strtolower(arg(1)) == 'nys') $reg = 'State';
else $reg = 'City';
if (strtolower(arg(2)) == 'revenue') $budg = 'Revenues';
else $budg = 'Expenses'; ?>
          <?php print '<h2>Budget Navigator</h2><h3>New York ' . $reg . ' ' . $budg . '</h3><p>The CBC Budget Navigator lets you explore the New York budgets on your own terms. Compare figures from past years, spot trends and relationships, and help us keep a close eye on New York\'s finances! Select your categories and click Add to create a list of categories to compare. When you\'re done, click Apply to update the chart.</p>';          ?>
