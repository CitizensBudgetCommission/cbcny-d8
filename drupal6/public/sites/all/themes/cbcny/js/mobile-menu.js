(function ($) {
  ...
  Drupal.behaviors.mobileMenu = function (context) {
      ...
      var $mobileNav = $('<nav class="mobile-nav" role="navigation"></nav>'),
          ...
          $mainMenu = $('#primary-menu-links ul:first-child').clone(),
      ...
      $mainMenu.removeAttr('id').attr('class', 'nav nav--mobile').find('ul').each(function () {
        ...
        $parentLink.clone().prependTo(this).wrap('<li class="leaf parent"></li>');

        // Change parent link into a button and add classes.
        $parentLink.replaceWith('<a class="nav__link nav__link--parent js-mobile-menu-parent">' + $parentLink.text() + '</a>');
                                
                                //function () {
          //eturn $('<button class="nav__link nav__link--parent js-mobile-menu-parent" />').append($(this).contents());
      ...
      $('.js-mobile-menu-button', context).click(function (e) {
        ...
        $(this).not('.active-trail').mouseleave(function () {
          $(this).blur()
        });
      ...
      $('.js-mobile-menu-parent', context).click(function (e) {
        $(this).toggleClass('active-trail').next('ul').slideToggle();
