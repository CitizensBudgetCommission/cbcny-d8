...
namespace Drupal\cbc_dinner\Plugin\Commerce\CheckoutPane;
...
/**
 * Provides the contact information Custom pane.
 */
class ContactInformationCustom extends CheckoutPaneBase implements CheckoutPaneInterface {
  ...
  public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form) {
    ...
    if (!empty($this->order->getCustomerId())) {
      $pane_form['email']['#attributes'] = ['readonly' => 'readonly'];
      $pane_form['email']['#attributes'] = ['disabled' => 'disabled'];
    }
    if (empty($this->order->getCustomerId())) {
  ...
  public function validatePaneForm(array &$pane_form, FormStateInterface $form_state, array &$complete_form) {
    ...
    if (empty($this->order->getCustomerId()) && $this->configuration['double_entry'] && $values['email'] != $values['email_confirm']) {
